								...
								<ul class="navbar-nav">
                                    <li class="nav-item dropdown">
										...
										<ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="dropAluno">
											...
											<li><a href="cadastrarAluno.php" class="dropdown-item active" aria-current="page">Cadastrar</a></li>
            ...
            <main class="container-fluid">
                ...
                <div class="row justify-content-center">
                    <div class="col-auto">
                        ...
                        <form class="needs-validation" method="POST" action="cAluno.php" novalidate>
                            <div>
